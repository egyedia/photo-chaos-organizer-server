...
public class FilesystemMetaThumbnailDataHandler extends AsbtractPCHandler {
  ...
  public PCResponseObject doGet(HttpServletRequest request) {
    ...
    if (response.isOk()) {
      ...
      if (response.isOk()) {
        ...
        if (response.isOk()) {
          response = handleMetadata(request, response);
        }
      }
    }
    return response;
  ...
  private static PCResponseObject handleFile(HttpServletRequest request, PCResponseObject response) {
  ...
  private PCResponseObject handleMetadataObject(HttpServletRequest request, PCResponseObject response) {
  ...
  private PCResponseObject handleMetadata(HttpServletRequest request, PCResponseObject response) {
